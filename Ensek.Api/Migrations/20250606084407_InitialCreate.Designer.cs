...
namespace Ensek.Api.Migrations
{
    ...
    [Migration("20250606084407_InitialCreate")]
            ...
            modelBuilder.Entity("Ensek.Api.Model.MeterReading", b =>
                {
                    ...
                    b.HasKey("MeterReadingId")
                        .HasName("pk_meter_reading");

                    b.HasIndex("AccountId")
                        .HasDatabaseName("ix_meter_reading_account_id");
            ...
            modelBuilder.Entity("Ensek.Api.Model.MeterReading", b =>
                {
                    b.HasOne("Ensek.Api.Model.Account", "Account")
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_meter_reading_account_account_id");
